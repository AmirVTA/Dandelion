...
VOLUNTARYCHECK=0
I=1
BOT=Dandelion  # You can put here other bots. Also you can change it to run more than one bot in the same server.
RELOADTIME=60  # Time between checking cpu calls of the cli process. Set the value high if your bot does not receive lots of messages.
...
echo ""
echo -e "\e[01;34m STEADY SCRIPT RUNNING ...\e[00;37;40m"
echo ""
